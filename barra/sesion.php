...
$buscar_usuario = mysqli_query($conexion, "SELECT id_usuario FROM usuarios WHERE nombre_usuarios = '$usuar' and contrasena_usuarios='$contrasena' and area_usuarios='barra' and estatus_usuarios=1 limit 1");
