...
for ($i = 9; $i <= 22; $i++) {
    ...
    //CLIENTES POR HORA
    $sql=mysqli_query($conn, "SELECT count(*) as ventas FROM his_clientes where MONTH(fecha)='$mes' and YEAR(fecha)='$anual' and hora between '$hora' and '$horaFin'");
    ...
    switch ($hora) {
        ...
        case '19:00': $hora="7:00 pm"; break;
        case '20:00': $hora="8:00 pm"; break;
        case '21:00': $hora="9:00 pm"; break;
        case '22:00': $hora="10:00 pm"; break;
