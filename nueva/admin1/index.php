...
<body>
    ...
    <nav class="nav">
        <div class="contenedor_nav">
            <a href="../index.php"><i class="fa-solid fa-border-all"></i>Ordenar</a>
            <a href="../cocina/index.php"><i class="fa-solid fa-bowl-rice"></i>Cocina</a>
            <a href="../caja1/index.php"><i class="fa-solid fa-cash-register"></i>Caja</a>
        </div>
    </nav>
