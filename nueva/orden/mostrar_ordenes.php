...
where 
cli_fecha='$f' and cli_consumo='$numConsumo'") or die ("Problemas en el select 2:".mysqli_error($conexion));
...
if($cliord[0]>0){
    ...
    where 
    cli_fecha='$f' and cli_consumo='$numConsumo' order by cli_id_cliente asc") or die ("Problemas en el select 2:".mysqli_error($conexion));
