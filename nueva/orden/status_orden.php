...
mysqli_query($conexion, "UPDATE ordenes SET
                ord_status=2 WHERE ord_id_orden='$id' LIMIT 1");


//ACTUALIZAR LA HORA DE ENTREGA
mysqli_query($conexion, "UPDATE ordenes SET
ord_horaEntrega='$h' WHERE ord_id_orden='$id' LIMIT 1");

//VALIDAR ORDEN ENTREGADA
$contOrd = mysqli_query($conexion, "select ord_status from ordenes where ord_id_orden='$id' limit 1") or die 
