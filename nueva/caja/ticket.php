...
///////////////////////////////////////////////
//VARIABLES
$cuenta =json_decode($_GET['cue']);
$lugar=$cuenta->lugar;
$observacion=$cuenta->observacion;
$total=$cuenta->totalOrdenes;
$ordenes=$cuenta->ordenes;
$consumo=$cuenta->consumo;
$fecha=$cuenta->fechaVenta;
$hora=$cuenta->horaFormat;
...
$pdf->Cell(70,4,'Juarez 184, Tecalitlan Jal.',0,0,'C');;
$pdf->Cell(10,4, " ",0,1,'c');
$pdf->Cell(70,4,'Cel: 3411382883',0,0,'C');
$pdf->Cell(10,4, " ",0,1,'c');
...
if($observacion!="vacio"){
    $pdf->SetFont('Poppins-semibold','',10);//FUENTE
    $pdf->Multicell(72,6,utf8_decode($observacion),0,'C',0);//TITULO
}
$pdf->Ln(2);
