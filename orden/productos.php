...
$categorias=array('camarones','filetes','esp caliente','fajitas','cocteles',
                 ...
                 'mixologia','cortes','postre','bebidas','snacks', 'infantiles','licores', 'mariscadas', 'extras', "cervezas",'desayunos');
    ...
    $buscar_pro = mysqli_query($conexion, "SELECT pro_producto,pro_costo from productos where pro_categoria='$categorias[$c]' and pro_status=1") or die 
                       ...
                       while($pro=mysqli_fetch_row($buscar_pro)){
                        ...
                        switch($categorias[$c]){
                            ...
                            case 'desayunos': array_push($desa, $produc); break;
                        }                              
            }
}
...
array_push($proarray,$cama, $file,$espc,$faji,$coct,$agua,$cevi,$tost,$taco,$espf,$mixo,$cort,$post,$bebi,$snac, $inf, $lic, $mar, $ext, $cerv, $desa);
