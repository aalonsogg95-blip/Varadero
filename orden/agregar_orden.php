...
//VALIDAR CLIENTE
$contCli = mysqli_query($conexion, "SELECT cli_id_cliente from clientes where cli_fecha='$f' and cli_consumo='$con' and cli_lugar='$lug' and cli_eliminado=0") or die 
...
if(empty($idCli)){
    ...
    //INSERTAR CLIENTE
    $conexion->query("insert into clientes(cli_consumo, cli_lugar,cli_observacion,cli_hora, cli_fecha, cli_factura, cli_eliminado) values ('$con','$lug','$obserCelular', '$h','$f',0,0)"); 
...
if(!empty($idCli)){
    //INSERTAR ORDENES
$conexion->query("insert into ordenes(ord_categoria,ord_producto, ord_cantidad,ord_costo,ord_total,ord_hora,ord_status, ord_horaEntrega, cli_id_cliente,ord_usuario, ord_eliminado)  values ('$cat','$pro','$can','$cos','$tot','$h','1', '0', '$idCli','$usuario',0)"); 
