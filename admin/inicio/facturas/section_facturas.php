...
<section class='bd' id='facturas'>
        <div class='titulo_facturas bd titulo'>
            <h2>Facturas</h2>
                <ul class='bd'>
                    <li><h6>Facturas pendientes: </h6> <span id='facturasPendientes'> 0</span></li>
                </ul>
...
============================================= -->
    ...
    <script src='facturas/facturas.js'></script>