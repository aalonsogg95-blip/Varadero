...
///////////////////////////////////////////////
   ...
   //FORMATEAR FECHA Y HORA EN LA MISMA VARIABLE
    function formatearfechahora(fechaOriginal){
        ...
        const horasFormateadas = String(horas).padStart(2, '0');
         ...
         // Crear la cadena final con el formato deseado
        return fechaFormateada = `<i class="fa-solid fa-calendar-days"></i> ${dia}/${mes}/${año} <i class="fa-regular fa-clock"></i> ${horasFormateadas}:${minutos} ${ampm}`;
    }